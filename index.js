...
async function starts() {
	...
	client.on('qr', () => {
		console.log(color('[','white'), color('!','red'), color(']','white'), color('Un Hetero Me Acaba De Instalar, Esanea QR'))
	})
...
random = `${Math.floor(Math.random() * 100)}`
lesbiana = random
if (lesbiana < 20 ) {le = 'Usted es hetero mija😹'} else if (lesbiana == 21 ) {le = 'Media lesbiana🧐'} else if (le == 23 ) {le = 'Media lesbiana 🧐'} else if (lesbiana == 24 ) {le = 'Media lesbiana 🧐'} else if (lesbiana == 25 ) {le = 'Media lesbiana 🧐'} else if (lesbiana == 26 ) {le = 'Media lesbiana🧐'} else if (lesbiana == 27 ) {le = 'Media lesbiana🧐'} else if (lesbiana == 28 ) {le = 'Media lesbiana🧐'} else if (lesbiana == 29 ) {le = 'Media lesbiana🧐'} else if (le == 30 ) {lesbiana = 'Media lesbiana 🧐'} else if (lesbiana == 31 ) {le = 'Tengo mis dudas 😳'} else if (lesbiana == 32 ) {le = 'Tengo mi dudas 😑'} else if (lesbiana == 33 ) {le = 'Tengo mi dudas 😑'} else if (lesbiana == 34 ) {le = 'Tengo mi dudas 😑'} else if (lesbiana == 35 ) {le = 'Tengo mi dudas 😑'} else if (lesbiana == 36 ) {le = 'Tengo mi dudas 😑'} else if (lesbiana == 37 ) {le = 'Tengo mi dudas 😑'} else if (lesbiana == 38 ) {le = 'TTengo mi dudas 😑'} else if (lesbiana == 39 ) {le = 'Tengo mi dudas 😑'} else if (lesbiana == 40 ) {le = 'Tengo mi dudas 😑'} else if (lesbiana == 41 ) {le = 'Tengo razon? 😏'} else if (lesbiana == 42 ) {le = 'Tengo razon? 😏'} else if (lesbiana == 43 ) {le = 'Tengo razon? 😏'} else if (lesbiana == 44 ) {le = 'Tengo razon? 😏'} else if (lesbiana == 45 ) {le = 'Tengo razon? 😏'} else if (lesbiana == 67 ) {ga = 'Tengo razon? 😏'} else if (lesbiana == 47 ) {le = 'Tengo razon? 😏'} else if (lesbiana == 48 ) {le = 'Tengo razon? 😏'} else if (lesbiana == 49 ) {le = 'Tengo razon? 😏'} else if (lesbiana == 50 ) {le = 'Eres o no? 🧐'} else if (lesbiana > 51) {ga = 'Usted es una lesbiana 🥶 🥸'}
	...
	case 'x':
			...
			//ANTILINKS DE REDES SOCIALES FLACO ACEPTALO SOLO LO ESTAS EDITANDO REALMENTE DRAGÓN TE HIZO TODO ESTO	
				...
				case 'antidiscord':
					...
					if (args.length < 1) return reply('Coloque !antimenu para ver los comandos de activación de los antilinks')
					if (Number(args[0]) === 1) {
						if (isAntiDiscord) return reply('El antilink de Dioscord ya esta activo')
				...
				case 'antiface':
			       ...
			       case 'antilink':
					...
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (!isGroupAdmins) return reply(mess.only.ownerG)
					if (args.length < 1) return reply('Coloque 1antimenu para ver los comandos de activación de los antilinks')
					if (Number(args[0]) === 1) {
...
if (!isGroupAdmins) return reply(mess.only.admin)
if (!isGroup) return reply(mess.only.group)
if (mek.message.extendedTextMessage === null || mek.message.extendedTextMessage === undefined) return reply('Marca La Puta Que Se Va')
...
mentions(`Pedido recibido jefe✅\n\nRetirando cargo como admin 3,2,1 LISTOOOOO @${mentioned[0].split('@')[0]}\n*${groupMetadata.subject}*_`, mentioned, true)
client.groupDemoteAdmin(from, mentioned)
}
break
...
mentions(`Pedido recibido jefe✅\n\nAgregando cargo como admin 3,2,1 LISTOOOOO : @${mentioned[0].split('@')[0]}`, mentioned, true)
client.groupMakeAdmin(from, mentioned)
}
break				
				...
				case 'nsfwass':
					...
					case 'nsfwarmpits':
				        ...
				        uptime = process.uptime()
                                        ...
                                        break
                                case 'ttp':
					if (args.length < 1) return reply('Onta El Texto')
					ranp = getRandom('.png')
					rano = getRandom('.webp')
