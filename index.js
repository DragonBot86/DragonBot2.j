	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `¡HOLA NEFASTOO! @${num.split('@')[0]} Un gusto conocerte pana🐉\n\n⪥『Bienvenido/a a ${mdata.subject}』⪥\n\n𓍯Presentarse con Foto, Nombre, Edad Y Pais\n\n𓍯Evita hacer pendejadas y cumple las reglas, ok?, Diviértete<3\n\n𓍯𝗡𝗼 𝘃𝗲𝗻𝗴𝗮𝘀 𝗵𝗮𝗰𝗲𝗿 𝗯𝗮𝗿𝗱𝗼, 𝗽𝗲𝗻𝗱𝗲𝗷𝗼, 𝗲𝗱𝗮𝗱 𝗽𝗲𝗿𝗺𝗶𝘁𝗶𝗱𝗮 𝟷𝟺 𝛂 𝟸𝟻`
